...
export interface TypeaheadProps {
  ...
  /** Aria-label attribute for the text input */
  ariaLabel?: string
  /** Style for the expandable list of results */
  expanderStyle?: ExpanderStyle
  /** Height of the expandable list of results */
  expanderHeight?: string
}
...
const Typeahead = ({
  ...
  // Whether expanderStyle is a function or an object, incorporate the default
  // style properties
  const expanderStyleWithDefaults =
    typeof expanderStyle === 'function'
      ? (props: ExpanderProps) => ({
          ...defaultExpanderStyle,
          ...(expanderStyle as ExpanderStyleAsFunction)(props),
        })
      : { ...defaultExpanderStyle, ...expanderStyle }
  ...
  return (
    ...
    >
      ...
      <Expander
        floating
        open={showResults}
        style={expanderStyleWithDefaults}
        animDuration={200}
